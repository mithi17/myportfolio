    ...
    >
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent leading-right">
            Hi, I'm Mithilesh
          </h1>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a
             ...
             hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.2)] hover:bg-green-400/10"
            >
              Contact Me
            </a>
          </div>
